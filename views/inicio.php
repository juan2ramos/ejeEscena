...
<section class="<?php echo($url) ?>">
  <article class="column-2 column-first">
    El Festival Internacional de Teatro de Manizales en asocio con el Ministerio de Cultura y con el apoyo de REDLAT / Circulart, busca generar espacios de circulación y difusión de las artes escénicas del Eje Cafetero a nivel nacional e internacional. Las diversas manifestaciones de las artes escénicas, teatro, danza, circo, títeres y muñecos, el teatro en espacios públicos, etc., tendrán la oportunidad de participar de un importante espacio en el panorama de la creación, circulación y distribución en Colombia e Iberoamérica.
  </article>
